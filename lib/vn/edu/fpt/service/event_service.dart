...
class EventService {
  const EventService({ApiClient client = const ApiClient()}) : _client = client;

  final ApiClient _client;

  Future<List<SchoolEvent>> fetchActiveEvents() async {
    ...
    return data
        .map((item) => SchoolEvent.fromJson(_jsonMap(item)))
  ...
  Map<String, dynamic> _jsonMap(dynamic value) {
    ...
    throw const FormatException('Phần tử sự kiện không hợp lệ');
  }
}
